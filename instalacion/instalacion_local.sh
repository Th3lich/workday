...
RUTA_ENTORNO=/home/dreams/entornos/
DIRECTORIO_PROYECTO=/home/dreams/git/Django/universitariosApuros/
ARCHIVO_WSGI=${DIRECTORIO_PROYECTO}configuracion/apache.wsgi


# creacion del archivo de configuracion de apache
ARCHIVO_CONF_APACHE=/home/dreams/pruebas/${NOMBRE_ENTORNO}.conf
