!function (e, t) {
    ...
    "use strict";
    var t = [], x = T.document, i = Object.getPrototypeOf, a = t.slice, g = t.concat, l = t.push, r = t.indexOf, n = {}, o = n.toString, m = n.hasOwnProperty, s = m.toString, u = s.call(Object), v = {}, y = function (e) {
    ...
    var p = function (n) {
        var e, d, _, o, r, p, f, g, w, l, u, E, T, s, x, m, a, c, v, C = "sizzle" + 1 * new Date, y = n.document, S = 0, i = 0, h = se(), b = se(), A = se(), D = function (e, t) {
            return e === t && (u = !0), 0
        }, N = {}.hasOwnProperty, t = [], I = t.pop, k = t.push, O = t.push, L = t.slice, j = function (e, t) {
            for (var n = 0, i = e.length; n < i; n++)if (e[n] === t)return n;
            return -1
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + P + "*(" + q + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + P + "*\\]", M = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", W = new RegExp(P + "+", "g"), F = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$", "g"), B = new RegExp("^" + P + "*," + P + "*"), U = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), z = new RegExp("=" + P + "*([^\\]'\"]*?)" + P + "*\\]", "g"), Q = new RegExp(M), $ = new RegExp("^" + q + "$"), K = {
            ID: new RegExp("^#(" + q + ")"),
            CLASS: new RegExp("^\\.(" + q + ")"),
            TAG: new RegExp("^(" + q + "|[*])"),
            ATTR: new RegExp("^" + R),
        ...
        }, V = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, X = /^[^{]+\{\s*\[native \w/, G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + P + "?|(" + P + ")|.)", "ig"), ee = function (e, t, n) {
            var i = "0x" + t - 65536;
        ...
        for (e in d = oe.support = {}, r = oe.isXML = function (e) {
            ...
            var n = _.attrHandle[t.toLowerCase()], i = n && N.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !x) : void 0;
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === g && 0 === m ? function (e) {
                            ...
                            var i, r, o, s, a, l, u = v !== y ? "nextSibling" : "previousSibling", c = e.parentNode, f = b && e.nodeName.toLowerCase(), h = !n && !b, d = !1;
                            if (c) {
                                if (v) {
                                    for (; u;) {
                                ...
                                } else if (h && (d = a = (i = (r = (o = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]), !1 === d)for (; (s = ++a && s && s[u] || (d = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]), s !== e)););
            ...
            pseudos: {
                not: ae(function (e) {
                    ...
                    return $.test(n || "") || oe.error("unsupported lang: " + n), n = n.replace(Z, ee).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        function we(d, p, g, m, v, e) {
            return m && !m[C] && (m = we(m)), v && !v[C] && (v = we(v, e)), ae(function (e, t, n, i) {
                var r, o, s, a = [], l = [], u = t.length, c = e || function (e, t, n) {
                        ...
                        return n
                    }(p || "*", n.nodeType ? [n] : n, []), f = !d || !e && p ? c : _e(c, a, d, n, i), h = g ? v || (e ? d : u || m) ? [] : t : f;
                if (g && g(f, h, n, i), m)for (r = _e(h, l), m(r, [], n, i), o = r.length; o--;)(s = r[o]) && (h[l[o]] = !(f[l[o]] = s));
                if (e) {
                    if (v || d) {
                        if (v) {
        ...
        function Ee(e) {
            for (var r, t, n, i = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = ye(function (e) {
                ...
                return r = null, i
            }]; a < i; a++)if (t = _.relative[e[a].type]) c = [ye(be(c), t)]; else {
                if ((t = _.filter[e[a].type].apply(null, e[a].matches))[C]) {
                    for (n = ++a; n < i && !_.relative[e[n].type]; n++);
                    return we(1 < a && be(c), 1 < a && ve(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(F, "$1"), t, a < n && Ee(e.slice(a, n)), n < i && Ee(e = e.slice(n)), n < i && ve(e))
                }
                c.push(t)
            }
            return be(c)
        ...
        return me.prototype = _.filters = _.pseudos, _.setFilters = new me, p = oe.tokenize = function (e, t) {
            ...
            if (!s) {
                ...
                (s = A(e, (m = o, y = 0 < (v = r).length, b = 0 < m.length, i = function (e, t, n, i, r) {
                    var o, s, a, l = 0, u = "0", c = e && [], f = [], h = w, d = e || b && _.find.TAG("*", r), p = S += null == h ? 1 : Math.random() || .1, g = d.length;
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (r = K.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !_.relative[a = s.type]);)if ((l = _.find[a]) && (i = l(s.matches[0].replace(Z, ee), J.test(o[0].type) && ge(t.parentNode) || t))) {
    ...
    (C.fn.init = function (e, t, n) {
        ...
        if (i[1]) {
            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), N.test(i[1]) && C.isPlainObject(t))for (i in t)y(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
    ...
    var te = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ne = new RegExp("^(?:([+-])=|)(" + te + ")([a-z%]*)$", "i"), ie = ["Top", "Right", "Bottom", "Left"], re = function (e, t) {
    ...
    function se(e, t, n, i) {
        var r, o, s = 20, a = i ? function () {
                ...
                return C.css(e, t, "")
            }, l = a(), u = n && n[3] || (C.cssNumber[t] ? "" : "px"), c = (C.cssNumber[t] || "px" !== u && +l) && ne.exec(C.css(e, t));
        if (c && c[3] !== u) {
    ...
    function ye(e, t, n, i, r) {
        for (var o, s, a, l, u, c, f = t.createDocumentFragment(), h = [], d = 0, p = e.length; d < p; d++)if ((o = e[d]) || 0 === o)if ("object" === w(o)) C.merge(h, o.nodeType ? [o] : o); else if (ve.test(o)) {
        ...
        for (f.textContent = "", d = 0; o = h[d++];)if (i && -1 < C.inArray(o, i)) r && r.push(o); else if (u = C.contains(o.ownerDocument, o), s = de(f.appendChild(o), "script"), u && pe(s), n)for (c = 0; o = s[c++];)fe.test(o.type || "") && n.push(o);
        return f
    }
    ...
    var be = x.documentElement, _e = /^key/, we = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ee = /^([^.]*)(?:\.(.+)|)/;
    ...
    C.event = {
        global: {}, add: function (t, e, n, i, r) {
            ...
            if (m)for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(be, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(P) || [""]).length; u--;)if (d = g = (a = Ee.exec(t[u]) || [])[1], p = (a[2] || "").split(".").sort(), d) {
    ...
    var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, De = /<script|<style|<link/i, Ne = /checked\s*(?:[^=]|=\s*.checked.)/i, Ie = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function He(n, i, r, o) {
        ...
        if (f && (t = (e = ye(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)for (u = s[s.length - 1].ownerDocument, C.map(s, Le), c = 0; c < a; c++)l = s[c], fe.test(l.type || "") && !X.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : _(l.textContent.replace(Ie, ""), u, l))
        }
        return n
    }
    ...
    C.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))for (s = de(c), i = 0, r = (o = de(e)).length; i < r; i++)a = o[i], l = s[i], void 0, "input" === (u = l.nodeName.toLowerCase()) && ue.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)if (n)for (o = o || de(e), s = s || de(c), i = 0, r = o.length; i < r; i++)je(o[i], s[i]); else je(e, c);
    ...
    var qe = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"), Re = function (e) {
    ...
    var Be = /^(none|table(?!-c[ea]).+)/, Ue = /^--/, ze = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Qe = {letterSpacing: "0", fontWeight: "400"}, $e = ["Webkit", "Moz", "ms"], Ke = x.createElement("div").style;
    ...
    function Ge(e, t, n) {
        var i = Re(e), r = We(e, t, i), o = "border-box" === C.css(e, "boxSizing", !1, i), s = o;
        if (qe.test(r)) {
            if (!n)return r;
            r = "auto"
        }
    ...
    C.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = K(t), l = Ue.test(t), u = e.style;
        ...
        C.cssHooks[a] = {
            get: function (e, t, n) {
                ...
                var i, r = Re(e), o = "border-box" === C.css(e, "boxSizing", !1, r), s = n && Xe(e, a, n, o, r);
        ...
        if (t)return (parseFloat(We(e, "marginLeft")) || e.getBoundingClientRect().left - oe(e, {marginLeft: 0}, function () {
    ...
    var Ze, et, tt, nt, it = /^(?:toggle|show|hide)$/, rt = /queueHooks$/;
    ...
    function ut(o, e, t) {
        var n, s, i = 0, r = ut.prefilters.length, a = C.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s)return !1;
        ...
        }(c, u.opts.specialEasing); i < r; i++)if (n = ut.prefilters[i].call(u, o, c, u.opts))return y(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
    ...
    C.Animation = C.extend(ut, {
        tweeners: {
            ...
            var i, r, o, s, a, l, u, c, f = "width" in t || "height" in t, h = this, d = {}, p = e.style, g = e.nodeType && re(e), m = X.get(e, "fxshow");
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = X.get(e, "display")), "none" === (c = C.css(e, "display")) && (u ? c = u : (le([e], !0), u = e.style.display || u, c = C.css(e, "display"), le([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === C.css(e, "float") && (l || (h.done(function () {
                p.display = u
            }), null == u && (c = p.display, u = "none" === c ? "" : c)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", h.always(function () {
                p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
            })), l = !1, d)l || (m ? "hidden" in m && (g = m.hidden) : m = X.access(e, "fxshow", {display: u}), o && (m.hidden = !g), g && le([e], !0), h.done(function () {
    ...
    C.fn.extend({
        ...
        addClass: function (t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function (e) {
                        ...
                        var e, t, n, i;
                        if (s)for (t = 0, n = C(this), i = mt(r); e = i[t++];)n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else void 0 !== r && "boolean" !== o || ((e = gt(this)) && X.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : X.get(this, "__className__") || ""))
                    })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, i) {
            var r, o, s, a, l, u, c, f, h = [n || x], d = m.call(e, "type") ? e.type : e, p = m.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !yt.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), l = d.indexOf(":") < 0 && "on" + d, (e = e[C.expando] ? e : new C.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                ...
                for (r = 0; (o = h[r++]) && !e.isPropagationStopped();)f = o, e.type = 1 < r ? a : c.bindType || d, (u = (X.get(o, "events") || {})[e.type] && X.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && V(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
    ...
    var _t = T.location, wt = Date.now(), Et = /\?/;
    ...
    var Dt = /%20/g, Nt = /#.*$/, It = /([?&])_=[^&]*/, kt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ot = /^(?:GET|HEAD)$/, Lt = /^\/\//, jt = {}, Ht = {}, Pt = "*/".concat("*"), qt = x.createElement("a");
    ...
    qt.href = _t.href, C.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, h, n, d, i, p, g, r, o, m = C.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? C(v) : C.event, b = C.Deferred(), _ = C.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", E = {
                readyState: 0,
                getResponseHeader: function (e) {
                    var t;
                    if (p) {
                        if (!n)for (n = {}; t = kt.exec(h);)n[t[1].toLowerCase()] = t[2];
                        t = n[e.toLowerCase()]
                    }
    ...
    var r = "alert", o = "bs.alert", a = "." + o, u = p.fn[r], c = {
        CLOSE: "close" + a,
        CLOSED: "closed" + a,
        CLICK_DATA_API: "click" + a + ".data-api"
    }, f = "alert", h = "fade", d = "show", m = function () {
        function i(e) {
            this._element = e
        }
    ...
    var v = "button", y = "bs.button", b = "." + y, _ = ".data-api", w = p.fn[v], E = "active", T = "btn", x = "focus", C = '[data-toggle^="button"]', S = '[data-toggle="buttons"]', A = 'input:not([type="hidden"])', D = ".active", N = ".btn", I = {
    ...
    var O = "carousel", L = "bs.carousel", j = "." + L, H = ".data-api", P = p.fn[O], q = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
        ...
        return e.next = function () {
            ...
            var n = this._getItemIndex(e), i = this._getItemIndex(this._element.querySelector(Z)), r = p.Event(U.SLIDE, {
                relatedTarget: e,
                direction: t,
                from: i,
                to: n
    ...
    var le = "collapse", ue = "bs.collapse", ce = "." + ue, fe = p.fn[le], he = {
        toggle: !0,
        parent: ""
    ...
    }, ge = "show", me = "collapse", ve = "collapsing", ye = "collapsed", be = "width", _e = "height", we = ".show, .collapsing", Ee = '[data-toggle="collapse"]', Te = function () {
        function a(t, e) {
    ...
    for (var xe = "undefined" != typeof window && "undefined" != typeof document, Ce = ["Edge", "Trident", "Firefox"], Se = 0, Ae = 0; Ae < Ce.length; Ae += 1)if (xe && 0 <= navigator.userAgent.indexOf(Ce[Ae])) {
        Se = 1;
        break
    }
    ...
    var Le = xe && !(!window.MSInputMethodContext || !document.documentMode), je = xe && /MSIE 10/.test(navigator.userAgent);
    ...
    function Ke(e) {
        ...
        }, o = "HTML" === e.nodeName ? Be(e.ownerDocument) : {}, s = o.width || e.clientWidth || r.right - r.left, a = o.height || e.clientHeight || r.bottom - r.top, l = e.offsetWidth - s, u = e.offsetHeight - a;
        if (l || u) {
            var c = Ie(e);
    ...
    function Ve(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = He(10), r = "HTML" === t.nodeName, o = Ke(e), s = Ke(t), a = Oe(e), l = Ie(t), u = parseFloat(l.borderTopWidth, 10), c = parseFloat(l.borderLeftWidth, 10);
    ...
    var dt = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], pt = dt.slice(3);
        ...
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, s = o.popper, a = o.reference, l = -1 !== ["left", "right"].indexOf(r), u = l ? "height" : "width", c = l ? "Top" : "Left", f = c.toLowerCase(), h = l ? "left" : "top", d = l ? "bottom" : "right", p = Ze(i)[u];
                    a[d] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[d] - p)), a[f] + p > s[d] && (e.offsets.popper[f] += a[f] + p - s[d]), e.offsets.popper = $e(e.offsets.popper);
                    var g = a[f] + a[u] / 2 - p / 2, m = Ie(e.instance.popper), v = parseFloat(m["margin" + c], 10), y = parseFloat(m["border" + c + "Width"], 10), b = g - e.offsets.popper[f] - v - y;
                ...
                order: 600, enabled: !0, fn: function (p, g) {
                    ...
                    return _.forEach(function (e, t) {
                        ...
                        var n, i = p.offsets.popper, r = p.offsets.reference, o = Math.floor, s = "left" === v && o(i.right) > o(r.left) || "right" === v && o(i.left) < o(r.right) || "top" === v && o(i.bottom) > o(r.top) || "bottom" === v && o(i.top) < o(r.bottom), a = o(i.left) < o(m.left), l = o(i.right) > o(m.right), u = o(i.top) < o(m.top), c = o(i.bottom) > o(m.bottom), f = "left" === v && a || "right" === v && l || "top" === v && u || "bottom" === v && c, h = -1 !== ["top", "bottom"].indexOf(v), d = !!g.flipVariations && (h && "start" === b && a || h && "end" === b && l || !h && "start" === b && u || !h && "end" === b && c);
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var s, a, l, u, c, f, h, d, p, g, m, v, y, b, _ = void 0 !== o ? o : t.gpuAcceleration, w = Pe(e.instance.popper), E = Ke(w), T = {position: r.position}, x = (s = e, a = window.devicePixelRatio < 2 || !ft, l = s.offsets, u = l.popper, c = l.reference, f = Math.round, h = Math.floor, d = function (e) {
                        return e
                    ...
                    if (N = "bottom" === C ? "HTML" === w.nodeName ? -w.clientHeight + x.bottom : -E.height + x.bottom : x.top, D = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + x.right : -E.width + x.right : x.left, _ && A) T[A] = "translate3d(" + D + "px, " + N + "px, 0)", T[C] = 0, T[S] = 0, T.willChange = "transform"; else {
    ...
    var Et = "dropdown", Tt = "bs.dropdown", xt = "." + Tt, Ct = ".data-api", St = p.fn[Et], At = new RegExp("38|40|27"), Dt = {
        HIDE: "hide" + xt,
        HIDDEN: "hidden" + xt,
        SHOW: "show" + xt,
        SHOWN: "shown" + xt,
    ...
    }, Nt = "disabled", It = "show", kt = "dropup", Ot = "dropright", Lt = "dropleft", jt = "dropdown-menu-right", Ht = "position-static", Pt = '[data-toggle="dropdown"]', qt = ".dropdown form", Rt = ".dropdown-menu", Mt = ".navbar-nav", Wt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Ft = "top-start", Bt = "top-end", Ut = "bottom-start", zt = "bottom-end", Qt = "right-start", $t = "left-start", Kt = {
        offset: 0,
        flip: !0,
    ...
    var Xt = "modal", Gt = "bs.modal", Jt = "." + Gt, Zt = p.fn[Xt], en = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, rn = "modal-dialog-scrollable", on = "modal-scrollbar-measure", sn = "modal-backdrop", an = "modal-open", ln = "fade", un = "show", cn = ".modal-dialog", fn = ".modal-body", hn = '[data-toggle="modal"]', dn = '[data-dismiss="modal"]', pn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", gn = ".sticky-top", mn = function () {
        function r(e, t) {
    ...
    var En = "tooltip", Tn = "bs.tooltip", xn = "." + Tn, Cn = p.fn[En], Sn = "bs-tooltip", An = new RegExp("(^|\\s)" + Sn + "\\S+", "g"), Dn = ["sanitize", "whiteList", "sanitizeFn"], Nn = {
        animation: "boolean",
        template: "string",
    ...
    }, Hn = "fade", Pn = "show", qn = ".tooltip-inner", Rn = ".arrow", Mn = "hover", Wn = "focus", Fn = "click", Bn = "manual", Un = function () {
        function i(e, t) {
    ...
    var zn = "popover", Qn = "bs.popover", $n = "." + Qn, Kn = p.fn[zn], Vn = "bs-popover", Yn = new RegExp("(^|\\s)" + Vn + "\\S+", "g"), Xn = l({}, Un.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), Gn = l({}, Un.DefaultType, {content: "(string|element|function)"}), Jn = "fade", Zn = "show", ei = ".popover-header", ti = ".popover-body", ni = {
        HIDE: "hide" + $n,
        HIDDEN: "hidden" + $n,
        SHOW: "show" + $n,
        SHOWN: "shown" + $n,
    ...
    var ri = "scrollspy", oi = "bs.scrollspy", si = "." + oi, ai = p.fn[ri], li = {
        offset: 10,
        method: "auto",
        target: ""
    }, ui = {offset: "number", method: "string", target: "(string|element)"}, ci = {
        ACTIVATE: "activate" + si,
        SCROLL: "scroll" + si,
        LOAD_DATA_API: "load" + si + ".data-api"
    }, fi = "dropdown-item", hi = "active", di = '[data-spy="scroll"]', pi = ".nav, .list-group", gi = ".nav-link", mi = ".nav-item", vi = ".list-group-item", yi = ".dropdown", bi = ".dropdown-item", _i = ".dropdown-toggle", wi = "offset", Ei = "position", Ti = function () {
        function n(e, t) {
            var n = this;
        ...
        return e.refresh = function () {
            ...
            n.hasClass(fi) ? (n.closest(yi).find(_i).addClass(hi), n.addClass(hi)) : (n.addClass(hi), n.parents(pi).prev(gi + ", " + vi).addClass(hi), n.parents(pi).prev(mi).children(gi).addClass(hi)), p(this._scrollElement).trigger(ci.ACTIVATE, {relatedTarget: t})
        }, e._clear = function () {
    ...
    var xi = "bs.tab", Ci = "." + xi, Si = p.fn.tab, Ai = {
    ...
    }, Di = "dropdown-menu", Ni = "active", Ii = "disabled", ki = "fade", Oi = "show", Li = ".dropdown", ji = ".nav, .list-group", Hi = ".active", Pi = "> li > .active", qi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Ri = ".dropdown-toggle", Mi = "> .dropdown-menu .active", Wi = function () {
        function i(e) {
            this._element = e
        }
        ...
        return e.show = function () {
            ...
            var i = this, r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(Hi) : p(t).find(Pi))[0], o = n && r && p(r).hasClass(ki), s = function () {
    ...
    var Fi = "toast", Bi = "bs.toast", Ui = "." + Bi, zi = p.fn[Fi], Qi = {
        ...
        SHOW: "show" + Ui,
        SHOWN: "shown" + Ui
    }, $i = "fade", Ki = "hide", Vi = "show", Yi = "showing", Xi = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    ...
    D.fn.extend({
        slimScroll: function (S) {
            ...
            return this.each(function () {
                var i, e, r, n, o, s, a, l, u = "<div></div>", c = 30, f = !1, h = D(this);
                if (h.parent().hasClass(A.wrapperClass)) {
                    ...
                    if (b = h.siblings("." + A.barClass), y = h.siblings("." + A.railClass), T(), D.isPlainObject(S)) {
                        ...
                        if ("scrollTo" in S) d = parseInt(A.scrollTo); else if ("scrollBy" in S) d += parseInt(A.scrollBy); else if ("destroy" in S)return b.remove(), y.remove(), void h.unwrap();
                        E(d, !1, !0)
                    }
                    ...
                    }), T(), "bottom" === A.start ? (b.css({top: h.outerHeight() - b.outerHeight()}), E(0, !0)) : "top" !== A.start && (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()), v = this, window.addEventListener ? (v.addEventListener("DOMMouseScroll", w, !1), v.addEventListener("mousewheel", w, !1)) : document.attachEvent("onmousewheel", w)
                }
                function w(e) {
                    if (i) {
                        var t = 0;
                ...
                function E(e, t, n) {
                    f = !1;
                    var i = e, r = h.outerHeight() - b.outerHeight();
                    if (t && (i = parseInt(b.css("top")) + e * parseInt(A.wheelStep) / 100 * b.outerHeight(), i = Math.min(Math.max(i, 0), r), i = 0 < e ? Math.ceil(i) : Math.floor(i), b.css({top: i + "px"})), i = (a = parseInt(b.css("top")) / (h.outerHeight() - b.outerHeight())) * (h[0].scrollHeight - h.outerHeight()), n) {
                ...
                function T() {
                    s = Math.max(h.outerHeight() / h[0].scrollHeight * h.outerHeight(), c), b.css({height: s + "px"});
    ...
    return n = "." + (s = t = "metisMenu"), i = (a = e).fn[t], l = {
        ...
        return e.init = function () {
            ...
            a(this.element).find(s.parentTrigger + "." + s.activeClass).has(s.subMenu).children(s.subMenu).addClass(s.collapseClass + " " + s.collapseInClass), a(this.element).find(s.parentTrigger).not("." + s.activeClass).has(s.subMenu).children(s.subMenu).addClass(s.collapseClass), a(this.element).find(s.parentTrigger).has(s.subMenu).children(s.triggerElement).on(u.CLICK_DATA_API, function (e) {
                var t = a(this), n = t.parent(s.parentTrigger), i = n.siblings(s.parentTrigger).children(s.triggerElement), r = n.children(s.subMenu);
            ...
            return this.each(function () {
                var e = a(this), t = e.data(s), n = o({}, l, e.data(), "object" == typeof i && i ? i : {});
    ...
    return t.init = function (e) {
        ...
        var n = (e = c(e)).length;
        if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, n)for (var i, r, o, s = {}, a = 0, l = {
            type: "mousedown",
            button: 1
        }, u = function (e, t) {
            return function () {
        ...
        for (var t = {type: "mouseup", button: 1}, n = 0, i = (e = c(e)).length; n < i; n++)d.hide(t, e[n])
    ...
    n.prototype.add = function (e) {
        ...
        for (var r in this.handleScroll(), e = {
            ...
            for (var s in this.waypoints[r]) {
                var a, l, u, c, f = this.waypoints[r][s], h = f.options.offset, d = f.triggerPoint, p = 0, g = null == d;
    ...
    v.fn.counterUp = function (e) {
        ...
        return this.each(function () {
            ...
            d.waypoint(function (e) {
                !function () {
                    var e = [], t = p.time / p.delay, n = v(this).attr("data-num") ? v(this).attr("data-num") : d.text(), i = /[0-9]+,[0-9]+/.test(n), r = ((n = n.replace(/,/g, "")).split(".")[1] || []).length;
                    ...
                    for (var l = t; l >= p.beginAt / n * t; l--) {
                        ...
                        if (o) {
                            u = parseInt(g / t * l);
                            var c = parseInt(u / 3600) % 24, f = parseInt(u / 60) % 60, h = parseInt(u % 60, 10);
